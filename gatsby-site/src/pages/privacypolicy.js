      ...
      >
        <div className="container-blog text-primary">
          ...
          <div className="ContentInner">
            ...
            <ol>
              <li className="mb-2">事業の内容及び規模を考慮して適切な個人情報の取得、利用及び提供を行います。また、取得した個人情報については目的外の利用を行いません。また、そのための措置を講じます。</li>
              <li className="mb-2">個人情報に関する事業上の要求事項及び法的又は国が定める指針、その他の規範・規制要求事項を遵守します。</li>
              <li className="mb-2">個人情報の漏えい、滅失または、き損などの防止及び是正を図ります。</li>
              <li className="mb-2">個人情報に関する苦情及び相談に対して、窓口を定め対応します。</li>
              <li className="mb-2">個人情報保護マネジメントシステムを確立し、維持するために必要な組織を整備します。また、個人情報保護マネジメントシステムの継続的改善を行います。</li>
            </ol>
            <div>
              <ul>
